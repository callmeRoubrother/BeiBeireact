  ...
  onChange = (val) => {
    ...
    componentDidMount() {
      if(this.props.isLogin !== 'ok'){
        this.props._this.props.history.push('/login')
      }
      ...
      <div className="contentCart">
        ...
        <div className="shopList" ref={index} key={index}>
          <div className="title">
            ...
            <span className="sp2">{item.prottitle}</span>
          ...
          <div className="shopImg" >
            ...
            <div className="shopKind" >
              ...
              <div className='num'>
                  <span onClick={this.reduce.bind(this,index,0,item.number)}>
                      &#8211;
                  </span>
                  &nbsp; <i ref={item.number}>{item.num}</i>  &nbsp;
                  <span onClick={this.reduce.bind(this,index,1,item.number)}>+</span>
              </div>
            </div>
          </div>
